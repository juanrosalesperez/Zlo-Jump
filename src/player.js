var player = new function() {
    ...
    this.update = function() {
        if (!dead) {
            ...
            ctx.fillText("Te odio!", screenWidth / 2, screenHeight / 2); 
            ctx.font = "36px Arial";
            ctx.fillText("Presiona espacio", screenWidth / 2, (screenHeight / 2) + 50);
            ctx.font = "36px Arial";
            ctx.fillText("SUBNORMAL", screenWidth / 2, (screenHeight / 2) + 100);
        }
